 ...
 *
 */
public class CommunityFragmentBusiness extends Fragment
{
	...
	private Handler mHandler=new Handler(){
		...
		public void handleMessage(Message msg)
		{
			...
			switch (msg.what)
			{
			case Constant.HandlerMessageCode.GET_USERINFOS_BUSINESS_SUCCESS:
				userInfolist.clear();
	...
	private void initData(){
			...
			NetControl.getShare(getActivity()).getUserInfos(Constant.UserType.User_TYPE_BUSINESS, page, mHandler);
	}
