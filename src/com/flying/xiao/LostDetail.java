...
//				imageView.setScaleType(ScaleType.FIT_XY);
	...
	{
		NetControl.getShare(LostDetail.this).getContentDetail(Constant.ContentType.CONTENT_TYPE_LOST, con.getId());
	...
	private View.OnClickListener collectClickListener = new View.OnClickListener()
	{
		...
		public void onClick(View v)
		{
			NetControl.getShare(LostDetail.this).collectOperate(con.getId(), con.isMeCollecte());
