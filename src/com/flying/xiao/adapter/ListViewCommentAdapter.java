...
public class ListViewCommentAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		String faceURL = comment.getXuserInfo().getUserHeadImageUrl();
		...
		listItemView.name.setText(comment.getXuserInfo().getUserRealName());
...
//		}
	...
	private View.OnClickListener faceClickListener = new View.OnClickListener()
	{
		...
		{
			XComment comment = (XComment) v.getTag();
